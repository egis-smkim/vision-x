...
var IDE = {
	...
	init:function() {
		...
		Module.XDEMapCreateLayer("Facility_Hamburg_LOD3", "https://basemap.egiscloud.com", 0, true, true, false, 29, 0, 15);
		Module.XDEMapCreateLayer("bldg_hamburg_lv14_240823", "https://basemap.egiscloud.com", 0, true, true, false, 29, 0, 14);

		var layerList = new Module.JSLayerList(false);
		// layerList.nameAtLayer("map_lv15_xnd").tile_load_ratio = 10
		// layerList.nameAtLayer("map_xnd").tile_load_ratio = 10
		layerList.nameAtLayer("Facility_Hamburg_LOD3").tile_load_ratio = 10
...
/*				layerList.nameAtLayer("facility_apt_14_level").setVisible(false);
	...
	MAPTOOL:{
		...
		goHome:function() {
			Module.getViewCamera().setViewAt( 9.9842019, 53.5492864, 58137, 90, 0);
			Module.XDRenderData();
