...
var IDE = {
    ...
    init:function() {
        ...
        // Module.XDEMapCreateLayer("map_lv15_xnd", "https://3dmap.egiscloud.com", 0, true, true, false, 29, 0, 15);
        // Module.XDEMapCreateLayer("map_xnd", "https://3dmap.egiscloud.com", 0, true, true, false, 29, 0, 15);
        //Module.XDEMapCreateLayer("Facility_Hamburg_xdo", "https://basemap.egiscloud.com", 0, true, true, false, 9, 0, 15);
        ...
        //    maxLevel : 15
        //});
        Module.XDEMapCreateLayer("Facility_Hamburg_lv16_1024_L2", "https://basemap.egiscloud.com", 0, true, true, false, 29, 0, 16);

        var layerList = new Module.JSLayerList(false);
        // layerList.nameAtLayer("map_lv15_xnd").tile_load_ratio = 10
        // layerList.nameAtLayer("map_xnd").tile_load_ratio = 10
        //layerList.nameAtLayer("Facility_Hamburg_xdo").tile_load_ratio = 10
        //layerList.nameAtLayer("Facility_Hamburg_xdo").tile_load_ratio = 10
        layerList.nameAtLayer("Facility_Hamburg_lv16_1024_L2").tile_load_ratio = 10;

        IDE.PRODUCT.init();
        IDE.MAPTOOL.init();	// sumin 201230
        IDE.PLACE.ps = new kakao.maps.services.Places();
        ...
        //BaseMap Health Check
        function checkHealthStatus() {
            return fetch('https://basemap.egiscloud.com/XDServer/health_check')
                .then(response => {
        ...
        checkHealthStatus().then(isHealthy => {
            if (!isHealthy) {
    ...
    MAP:{
        DEFAULT:{
            init:function() {
                // SETUP LAYERS
                //Module.XDEMapCreateLayer("hybrid_bound","xdworld.vworld.kr:8080", 0, false, true, false, 10, 0, 10);
                ...
                IDE.MAP.DEFAULT.dtCreateLayer("EGIS_tMap_World", "https://basemap.egiscloud.com", 0, true, false, false, 10, 0, 15);
                IDE.MAP.DEFAULT.dtCreateLayer("EGIS_hMap_World", "https://basemap.egiscloud.com", 0, true, false, false, 10, 0, 20);


                // DT 3DMap 서버는 http, https 모두 포트 입력 필요 없음.
                Module.XDEMapCreateLayer("facility_buildseoul", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 17);
                Module.XDEMapCreateLayer("tile_build_seoul", "3dmap.egiscloud.com", 0, true, true, false, 16, 10, 15);
                Module.XDEMapCreateLayer("facility_palaces", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 15);
                Module.XDEMapCreateLayer("facility_bridgehi", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 15);
                Module.XDEMapCreateLayer("facility_bridgelow", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 15);
                Module.XDEMapCreateLayer("hybrid_seoul25cm", "3dmap.egiscloud.com", 0, false, true, false, 10, 0, 17);
                Module.XDEMapCreateLayer("hybrid_seoul08", "3dmap.egiscloud.com", 0, false, true, false, 10, 0, 19);
                Module.XDEMapCreateLayer("ngii_fac_lod_1", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 15);
                Module.XDEMapCreateLayer("osan_fac", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 12);
                Module.XDEMapCreateLayer("eco_delta_v1", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 12);
                //jakarta
                Module.XDEMapCreateLayer("bldg_block_m_station", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 13);
                Module.XDEMapCreateLayer("buld_general", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("poi_jakarta_jibun", "3dmap.egiscloud.com", 0, false, false, false, 7, 0, 15);
                Module.XDEMapCreateLayer("hybrid_jakarta_jijuk_line", "3dmap.egiscloud.com", 0, false, false, false, 10, 0, 15);

                //berlin
                Module.XDEMapCreateLayer("bldg_tilemap_berlin_bake_240417", "3dmap.egiscloud.com", 0, true, false, false, 29, 0, 14);

                //대구 수성구 알파시티
                Module.XDEMapCreateLayer("bldg_alphacity_lv15_240612", "3dmap.egiscloud.com", 0, true, true, false, 29, 0, 15);

                //양평 미도
                Module.XDEMapCreateLayer("bldg_yp_building", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("bldg_yp_update_building", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("bldg_yp_update2_building", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("hybrid_yp_img", "3dmap.egiscloud.com", 0, false, false, false, 10, 0, 19);
                Module.XDEMapCreateLayer("hybrid_yp_add_img", "3dmap.egiscloud.com", 0, false, false, false, 10, 0, 18);

                //남양주, 속초
                Module.XDEMapCreateLayer("bldg_NYJ_building_level_15", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("bldg_SC_building_level_15", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);
                Module.XDEMapCreateLayer("hybrid_img_NYJ_4cm", "3dmap.egiscloud.com", 0, false, false, false, 10, 0, 20);
                Module.XDEMapCreateLayer("hybrid_img_SC_10cm", "3dmap.egiscloud.com", 0, false, false, false, 10, 0, 18);

                //서울시 BIM
                Module.XDEMapCreateLayer("seoul_bim", "www.egiscloud.com/userData/cityhall_demo/facility_catholic", 0, false, false, true, 9, 0, 12);

                Module.XDEMapCreateLayer("facility_gongwon", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 12);
                Module.XDEMapCreateLayer("osan_v1", "3dmap.egiscloud.com", 0, false, true, false, 10, 0, 16);
                Module.XDEMapCreateLayer("hy_ecodelta_v1", "3dmap.egiscloud.com", 0, false, true, false, 10, 0, 18);

                Module.XDEMapCreateLayer("facility_vive", "3dmap.egiscloud.com", 0, true, true, false, 9, 0, 12);

                //해양관련 레이어 추후 삭제
                Module.XDEMapCreateLayer("hybrid_undersea", "3dmap.egiscloud.com", 0, true, true, false, 10, 0, 14);

                //행안부 국가주소정보 잠실
                Module.XDEMapCreateLayer("bldg_jamsil_aed01_02_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_arrow01_13_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_fire01_04_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_jamsilb1_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_phone01_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_relief01_03_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_store001_208_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_toilet01_07_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_ls_apt_cube_level_14_230109", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_symbol01_05_level_14_230117", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_driveway_arrow_01_level_14_230117", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_driveway_arrow_02_level_14_230117", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_driveway_arrow_03_level_14_230117", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_driveway_arrow_04_level_14_230117", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 14);
                Module.XDEMapCreateLayer("bldg_jamsil_apt_111", "3dmap.egiscloud.com", 0, false, false, false, 9, 0, 15);

                //xdcloud
                IDE.MAP.DEFAULT.dtCreateLayer("57", "https://3dmap.xdcloud.kr", 0, true, false, false, 9, 0, 14);
                ...
                Module.setVisibleRange('osan_fac',parseFloat(5.0),20000);
                Module.setVisibleRange('eco_delta_v1',parseFloat(5.0),20000);

                Module.setVisibleRange('ngii_fac_lod_1',parseFloat(5.0),20000);
                Module.setVisibleRange('facility_gongwon',parseFloat(5.0),20000);

                Module.XDEMapCreateLayer("vive_golf_img", "www.egiscloud.com/userData/newlayer/MAP_DATA/image/convert/vive", 0, false, true, true, 10, 0, 20);
                //양평 LOD
                Module.XDEMapCreateLayer("facility_yp_real", "www.egiscloud.com/userData/newlayer/MAP_DATA/yp/facility_yp_real", 0, false, false, true, 20, 10, 12);
                //양평 건물 높이 DB
                Module.XDEMapCreateLayer("facility_yp_height", "www.egiscloud.com/userData/newlayer/MAP_DATA/yp/facility_yp", 0, false, true, true, 9, 0, 14);
                var layerList = new Module.JSLayerList(false);
                // yhb api가 없어졌다?
                //layerList.SyncLayer();
                layerList.nameAtLayer("facility_yp_height").simple_real3d = true;

                layerList.nameAtLayer("poi_jakarta_jibun").tile_load_ratio = 20;
                layerList.nameAtLayer("buld_general").tile_load_ratio = 6;
                layerList.nameAtLayer("buld_general").simple_real3d = true;

                layerList.nameAtLayer("bldg_alphacity_lv15_240612").tile_load_ratio = 10;

                /* 20220317~ */
                /*layerList.nameAtLayer("hybrid_bound").setVisible(false);
                layerList.nameAtLayer("hybrid_road").setVisible(false);
                layerList.nameAtLayer("poi_base").setVisible(true);
                layerList.nameAtLayer("poi_bound").setVisible(true);
                layerList.nameAtLayer("poi_road").setVisible(true);

                layerList.nameAtLayer("facility_build").setVisible(true);
                layerList.nameAtLayer("facility_bridge").setVisible(false);*/
                //$("input[name='def_vworld_layer']:checkbox[value=0]").attr("checked",false)

                /*용인시청 데모*/
                /*Module.XDEMapCreateLayer("facility_apt_14_level", "www.egiscloud.com/siteData/yiSample/facility_apt_14_level", 0, false, true, true, 9, 0, 14);
                Module.XDEMapCreateLayer("facility_tunnel_14_level", "www.egiscloud.com/siteData/yiSample/facility_tunnel_14_level", 0, false, true, true, 9, 0, 14);
                Module.XDEMapCreateLayer("facility_tree_14_level", "www.egiscloud.com/siteData/yiSample/facility_tree_14_level", 0, false, true, true, 9, 0, 14);
                Module.XDEMapCreateLayer("facility_road_14_level", "www.egiscloud.com/siteData/yiSample/facility_road_14_level", 0, false, true, true, 9, 0, 14);
                Module.XDEMapCreateLayer("facility_lamp_14_level", "www.egiscloud.com/siteData/yiSample/facility_lamp_14_level", 0, false, true, true, 9, 0, 14);

                Module.setVisibleRange("facility_apt_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_tunnel_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_tree_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_road_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_lamp_14_level", 3.0, 20000);
*/
                /*				layerList.nameAtLayer("facility_apt_14_level").setVisible(false);
                                layerList.nameAtLayer("facility_apt_14_level").setVisible(false);
                                layerList.nameAtLayer("facility_tunnel_14_level").setVisible(false);
                                layerList.nameAtLayer("facility_tree_14_level").setVisible(false);
                                layerList.nameAtLayer("facility_road_14_level").setVisible(false);
                                layerList.nameAtLayer("facility_lamp_14_level").setVisible(false); */

                /*울산시청 데모 */
                //Module.XDEMapCreateLayer("bldg_ulsancityhall", "www.dtwincloud.com/siteData/ulsancity/bldg_ulsancityhall_tree", 0, false, true, true, 9, 0, 14);
                //layerList.nameAtLayer("bldg_ulsancityhall").setVisible(false);
                //Module.setVisibleRange("bldg_ulsancityhall", 3.0, 20000);
                /* ~20220317 */
                layerList.nameAtLayer("facility_buildseoul").setVisible(false);
                layerList.nameAtLayer("tile_build_seoul").setVisible(false);

                layerList.nameAtLayer("ngii_fac_lod_1").setVisible(false);

                //해양관련 레이어 추후 삭제
                layerList.nameAtLayer("hybrid_undersea").setVisible(false);

                //바이브 골프
                layerList.nameAtLayer("vive_golf_img").setVisible(false);
                layerList.nameAtLayer("facility_vive").setVisible(false);

                layerList.nameAtLayer("facility_gongwon").setVisible(false);
                layerList.nameAtLayer("osan_fac").setVisible(false);
                layerList.nameAtLayer("eco_delta_v1").setVisible(false);
                layerList.nameAtLayer("osan_v1").setVisible(false);
                layerList.nameAtLayer("hy_ecodelta_v1").setVisible(false);

                layerList.nameAtLayer("facility_palaces").setVisible(false);
                layerList.nameAtLayer("facility_bridgehi").setVisible(false);
                layerList.nameAtLayer("facility_bridgelow").setVisible(false);
                layerList.nameAtLayer("hybrid_seoul25cm").setVisible(false);
                layerList.nameAtLayer("hybrid_seoul08").setVisible(false);

                //양평 건물 높이 DB
                layerList.nameAtLayer("facility_yp_height").setVisible(false);
                Module.setVisibleRange('facility_yp_height',parseFloat(10.0),50000);
                Module.setVisibleRange("facility_apt_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_tunnel_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_tree_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_road_14_level", 3.0, 20000);
                Module.setVisibleRange("facility_lamp_14_level", 3.0, 20000);
                // 서비스 모드 설정(지형영상) sumin 210504
    ...
    MAPTOOL:{
        ...
        init : function() {
            ...
            $.getScript("/assets/js/toolbar_marker.js", function() {
                IDE.MAPTOOL.isMarkerReady = true;
            });

            $.getScript("/assets/js/toolbar_drawing.js", function() {
        ...
        currentLocation:function(){
            if ("geolocation" in navigator) {
                navigator.geolocation.getCurrentPosition(function(info){
                    ...
                    Module.getViewCamera().moveLonLatAlt(info.coords.longitude, info.coords.latitude, 2000, true);
        ...
        goHome:function() {
            Module.getViewCamera().setViewAt( 9.9842019, 53.5492864, 6378137*3, 90, 0);
            Module.XDRenderData();
        ...
        saveScreenShot : function() {
            ...
            logoImage.src = "./assets/images/"+name+".png";
        },
        nationalPointEvent:function(e) {
            ...
            var imageName = null;
            imageName = "/assets/img/poi/poi_2.png";
    ...
    LAYER:{
        init:function() {
            console.log("MAPID:"+IDE.mapid);
            if(IDE.mapid != null && IDE.mapid != ""
                && D_MEMBER.MID != "" && D_MEMBER.MID > 0){
                dtcLayer.loadMapLayer();
            }
        }
    },
    MODULE:{
        ...
        closeModule:function(m) {
            if(window.location.href.indexOf("loadMapInfo.do") > -1){
                return;
            }
